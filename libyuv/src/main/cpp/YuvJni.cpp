...
extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_util_YuvUtil_MirrorYUV(JNIEnv *env, jclass type, jbyteArray src_, jint width,
                                       jint height, jbyteArray dst_) {
    jbyte *src = env->GetByteArrayElements(src_, NULL);
    jbyte *dst = env->GetByteArrayElements(dst_, NULL);

    // TODO
    mirrorI420(src, width, height, dst);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_util_YuvUtil_nv21toI420(JNIEnv *env, jclass type, jbyteArray src_, jint width,
                                        jint height, jbyteArray dst_) {
    jbyte *src = env->GetByteArrayElements(src_, NULL);
    jbyte *dst = env->GetByteArrayElements(dst_, NULL);
