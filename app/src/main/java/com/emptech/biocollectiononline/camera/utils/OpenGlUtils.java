...
public class OpenGlUtils {
    ...
    public static int loadTexture1(final ByteBuffer data, final int width,final int height, final int usedTexId) {
		if(data == null)
			return NO_TEXTURE;
	    int textures[] = new int[1];
	    data.position(0);
	...
	public static String readShaderFromRawResource(final int resourceId){
		final InputStream inputStream = App.get().getResources().openRawResource(
				resourceId);
