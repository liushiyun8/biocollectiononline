...
public class MagicCameraInputFilter extends GPUImageFilter{
    ...
    protected void onInit() {
        ...
        mFaceAreaLocation = GLES20.glGetUniformLocation(getProgram(), "faceArea");
        mScreenLocation = GLES20.glGetUniformLocation(getProgram(), "screen");
        setBeautyLevel(0);
    }
    ...
    public void setScreenSize(float width, float height) {
        setFloatVec2(mScreenLocation,new float[]{width,height} );
    }

    public void setFaceArea(float left, float top,float right,float bottom) {
        Log.e("FaceArea", "left:"+left+",top:"+top+",right:"+right+",bottom:"+bottom);
        setFloatVec4(mFaceAreaLocation,new float[]{left,top,right,bottom} );
    }
}