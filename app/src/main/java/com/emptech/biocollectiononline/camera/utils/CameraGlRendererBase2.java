...
import com.emptech.biocollectiononline.camera.CameraRenderer;
...
public abstract class CameraGlRendererBase2 implements GLSurfaceView.Renderer {
    ...
    public CameraGlRendererBase2(CameraGLSurfaceView view) {
        mView = view;
