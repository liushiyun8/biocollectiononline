...
public class Converter {
	...
	/**
	 * convert a Asc byte arrary to Hex byte arrary, ex. [0x00, 0x00, 0x34,
	 * 0x4E] -> [4E]
	 * 
	 * @param raw
	 *            Asc byte arrary
	...
	public static int byteToInt2(byte[] b) {
		// return (((int)b[0]) << 24) + (((int)b[1]) << 16) + (((int)b[2]) << 8)
		// + b[3];
	...
	public static String BytesToHexString(byte[] array, int BytesLen) {
		char[] buf = new char[BytesLen * 2];
