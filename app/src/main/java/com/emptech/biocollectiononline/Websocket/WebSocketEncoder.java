 ...
 */
package com.emptech.biocollectiononline.Websocket;
...
public class WebSocketEncoder extends ProtocolEncoderAdapter{
    ...
    public void encode(IoSession session, Object message, ProtocolEncoderOutput out) throws Exception {
        ...
        if(isHandshakeResponse){
            LogUtils.e("Encodeer","isHandshackeResponse" );
            ...
            LogUtils.e("Encodeer","isDataFramePacket"+",isRemoteWebSocket"+isRemoteWebSocket );
            ...
            if(message instanceof byte[]){
                resultBuffer=IoBuffer.allocate(1024);
                resultBuffer.setAutoExpand(true);
                resultBuffer.put((byte[]) message);
                resultBuffer.flip();
                resultBuffer=WebSocketEncoder.buildWSDataFrameBuffer(resultBuffer);
            }else
            throw (new Exception("message not a websocket type"));
        }
        LogUtils.e("Encodeer","写入Iobuffer" );
